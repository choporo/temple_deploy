...
function AboutTemple() {
  return (
    <div>
      <h2 className="text-lg p-5">1. 사찰 대표 용어</h2>
      <div className="mx-10 grid gap-y-3 lg:grid-cols-12 lg:gap-x-5">
        <div className="lg:col-span-7 font-bold tracking-wide text-sm leading-loose">
        ...
        <div className="lg:col-span-5 relative h-full">
          ...
          />
          <h6 className="text-center text-smtracking-wider text-sm">
            {"<"}용화사 - 약사여래, 관음보살, 문수보살, 보현보살{">"}
          </h6>
        </div>
      </div>
      <h4 className="mx-10 mb-2 hidden lg:flex tracking-wide text-sm leading-loose">
        {temple[1].label}
      </h4>
    </div>
  );
