...
export const temple: temple[] = [
  ...
  {
    label:
     "10)상좌부(테라바다) 불교 - 과거에는 '소승불교'라는 이름으로 불렸으나 이는 상좌부(큰 스님을 의미) 불교를 비난하기 위해 후대 붙여진 이름이다. 상좌부 또는 테라바다 불교가 올바를 명칭이다. 상좌부 불교는 고대 인도에서 시작된 초기 불교 학파로 석가모니가 사용한 언어인 팔리어로 된 경전만을 인정하며 계율과 개인의 해탈을 중시한다. 이를 위해 명상을 중심으로 마음의 고요와 깨달음을 얻는데 집중한다. 개인의 해탈에 집중하기 위해 승려들은 농사 등의 일을 하지 않으며 이런 이유로 사찰음식이라는 개념은 존재하지 않는다. 스리랑카, 태국, 라오스, 캄보디아 등 동남아 지역에 분포되어 있다."
  },
  {
    label:
    "11)대승 불교 - 팔리어 경전 이외 산스크리트어 경전도 인정한다. 대승 불교는 승려만의 종교였던 불교를 널리 민중에게까지 보급하기 위해 출가하지 않고 수행하는 신도를 포함하고자 하여 시작되었다. 대승 불교는 석가모니의 가르침을 널리 보급하고 중생을 구제하는 것을 목표로 하며 이를 위해 명상뿐만 아니라 경전 독송, 자비 등 공덕을 쌓는 것을 중시한다. 대승불교는 한국, 중국, 베트남, 티벳, 몽골 등 동북아시아 지역에 주로 분포되어 있다."
  }
];
